...
@com.lucidtechnics.blackboard.Event(appName="example", workspaceName="CocoTheMonkey", name="mango", workspaceIdentifier="fruitFor")
   ...
   extends Fruit
{
	...
	public void setEaten(boolean _eaten)
	{
		super.setEaten(_eaten);
	}
